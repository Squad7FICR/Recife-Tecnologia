...
import '../../css/relatorio/report.css';
    ...
    <div className="body">
        ...
        <div className="header-container">
          <nav className="user-menu font-1-m" id="nav-menu">
            ...
            <ul id="ul-menu" role="menu">
              ...
              <li>
                <a id="hora-atual1">{horaAtual}</a>
              </li>
              <li>
                <a id="data-atual1">{dataAtual}</a>
              </li>
              <li>
                <a href="">{user?.email}</a>
              </li>
              <li>
                <a onClick={logOut} href="/">
                  <img src={exit} alt="Exit Icon" width="24" height="24" />
                </a>
              </li>
            </ul>
          </nav>
          <div id="mobile-menu">
            <ul>
              ...
              <li>
                <a id="hora-atual2">{horaAtual}</a>
              </li>
              <li>
                <a id="data-atual2">{dataAtual}</a>
              </li>
              <li>
                <a>Nome Cliente</a>
              </li>
      ...
      <div className="container-relatório">
        <div className="submenu">
          <ul>
            <li>
              <a id="downloadButton" onClick={handleDownloadClick}>
                Baixar
              </a>
            </li>
            <li>
            ...
            <li>
              <a id="filtrodata">
                Filtrar período
                <p>Início</p>
                <input type="date" name="data" id="dataInicio" />
                <p>Fim</p>
                <input type="date" name="data" id="dataFim" />
                <button onClick={handleFiltrarClick} className="buttonFiltrar">
                  Filtrar
                </button>
              </a>
            </li>
          ...
          <div className="container-folharelatorio">
            ...
            <div className="folharelatorio" id="folharelatorio">
              ...
              <div className="container-tabela">
                ...
                <h3 className="titulodatabela">
                  Chamado por origem de requisição
                </h3>
                <table className="tabelarelatorio">
                  <tr>
                    <th>HelpDesk: </th>
              ...
              <footer className="footerRelatorio">
                ...
                <p>
                  Edf. Dos Despachantes Aduaneiros Praça do Arsenal da Marinha -
                  Recife, PE, 50030-360
                </p>
