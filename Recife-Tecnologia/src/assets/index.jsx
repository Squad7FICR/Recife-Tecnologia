          ...
          <header className="header-bg">
              <div className="header-container">
                  <div className="container-search">
                      <div className="container-imgsearch"><img src="./img/Dashboard/find.png" alt="search" /></div>
                  ...
                  <nav className="user-menu font-1-m" id="nav-menu">
                      ...
                      <ul id="ul-menu" role="menu">
                          ...
                          <li><a href=""><img src="./img/Dashboard/exitIcon.svg" alt="Google Icon" width="32" height="32" /></a></li>
                      </ul>
                  </nav>
                  <div id="mobile-menu">
                      <ul>
